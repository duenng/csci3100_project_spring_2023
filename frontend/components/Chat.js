...
<div className="flex">
    ...
    <div className="w-30 h-screen bg-gray-100">
    ...
    <div className="flex-grow h-screen flex flex-col">
        ...
        <div className=" w-full h-screen flex-glow bg-blue-100">
            <div className="flex items-end w-3/6 bg-gray-100 m-8 rounded-lg">
            ...
            <div className="flex justify-end">
                <div className="flex justify-between w-3/6 bg-blue-600 m-8 rounded-lg">
                    
                    <div className="p-5">
                        <div className="text-xs text-gray-100">Oh Yeah! Come on!</div>
