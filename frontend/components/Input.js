  ...
  return (
    <div className="flex pt-4 w-[600px] xl:ml-[370px] border-l border-r xl:min-w-[576px] sm:ml-[10%] max-w-xl ml-[px] flex-grow sm:pl-0 min-w-[15%]">
        ...
        <div className="w-full divide-y divide-purple-200 ">{/* hidden xl:inline leading-5 */}
            <div className="">
                <textarea rows={2} className="text-lg tracking-wide min-h-[50px] placeholder-gray-400 dark:placeholder-red-500 dark:text-black w-full focus:ring-0 border-none " placeholder="What's happening?" />
            </div>
